...
class FileDownloader:
    ...
    def parse_bytes(bytestr):
        ...
        deprecation_warning('yt_dude.FileDownloader.parse_bytes is deprecated and '
                            'may be removed in the future. Use yt_dude.utils.parse_bytes instead')
    ...
    def _report_progress_status(self, s, default_template):
        ...
        self.to_console_title(self.ydl.evaluate_outtmpl(
            progress_template.get('download-title') or 'yt-dude %(progress._default_template)s',
