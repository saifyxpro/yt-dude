...
class FragmentFD(FileDownloader):
    ...
    For each incomplete fragment download yt-dude keeps on disk a special
    bookkeeping file with download state and metadata (in future such files will
    be used for any incomplete download handled by yt-dude). This file is
    ...
    def report_retry_fragment(self, err, frag_index, count, retries):
        self.deprecation_warning('yt_dude.downloader.FragmentFD.report_retry_fragment is deprecated. '
                                 'Use yt_dude.downloader.FileDownloader.report_retry instead')
