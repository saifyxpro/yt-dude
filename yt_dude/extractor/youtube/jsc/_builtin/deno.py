...
from yt_dude.extractor.youtube.jsc._builtin.ejs import (
    EJSBaseJCP,
    Script,
    ScriptSource,
    ScriptType,
...
from yt_dude.extractor.youtube.jsc._builtin.vendor import load_script
...
from yt_dude.extractor.youtube.pot._provider import BuiltinIEContentProvider
from yt_dude.extractor.youtube.pot.provider import provider_bug_report_message
from yt_dude.utils import Popen, remove_terminal_sequences
from yt_dude.utils.networking import HTTPHeaderDict, clean_proxies

# KNOWN ISSUES:
# - Can't avoid analysis cache: https://github.com/yt-dude/yt-dude/pull/14849#issuecomment-3475840821
