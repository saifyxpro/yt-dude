...
from yt_dude.extractor.youtube.pot._registry import _pot_providers, _ptp_preferences
from yt_dude.networking import Request, Response
...
class PoTokenProvider(IEContentProvider, abc.ABC, suffix='PTP'):
    ...
    # For a list of WebPO client names, see yt_dude.extractor.youtube.pot.utils.WEBPO_CLIENTS.
