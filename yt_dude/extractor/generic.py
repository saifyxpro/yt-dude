...
class GenericIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        # https://github.com/yt-dude/yt-dude/pull/6775
        ...
        # https://github.com/yt-dude/yt-dude/commit/3e01ce744a981d8f19ae77ec695005e7000f4703
        ...
        # https://github.com/yt-dude/yt-dude/pull/12256
        ...
        # https://github.com/yt-dude/yt-dude/commit/80e8493ee7c3083f4e215794e4a67ba5265f24f7
        ...
        # https://github.com/yt-dude/yt-dude/issues/1476
        ...
        # https://github.com/yt-dude/yt-dude/commit/a318f59d14792d25b2206c3f50181e03e8716db7
        ...
        # https://github.com/yt-dude/yt-dude/commit/f3c0c77304bc0e5614a65c45629de22f067685ac
        ...
        # https://github.com/yt-dude/yt-dude/pull/5145
    ...
    def _real_extract(self, url):
                    ...
                    if default_search == 'auto_warning':
                        if re.match(r'^(?:url|URL)$', url):
                            raise ExtractorError(
                                f'Invalid URL:  {url!r} . Call yt-dude like this:  yt-dude -v "https://www.youtube.com/watch?v=BaW_jenozKc"  ',
                                expected=True)
                        else:
                            self.report_warning(
        ...
        # Do not impersonate by default; see https://github.com/yt-dude/yt-dude/issues/11335
        ...
        # test whether it's HTML or not). According to yt-dude default Accept-Encoding
        ...
        try:
            ...
            if not self._downloader._impersonate_target_available(ImpersonateTarget()):
                msg += ('see  https://github.com/yt-dude/yt-dude#impersonation  for '
        ...
        try:
            ...
            if doc.tag == 'rss':
                ...
                info_dict['formats'], info_dict['subtitles'] = self._parse_mpd_formats_and_subtitles(
                    doc,
                    # Do not use yt_dude.utils.base_url here since it will raise on file:// URLs
    ...
    def _extract_embeds(self, url, webpage, *, urlh=None, info_dict={}):
        ...
        if not found:
            ...
            # be supported by yt-dude thus this is checked the very last (see
            # https://dev.twitter.com/cards/types/player#On_twitter.com_via_desktop_browser)
