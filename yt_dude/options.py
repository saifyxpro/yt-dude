...
def parseOpts(overrideArguments=None, ignore_config_files='if_override'):  # noqa: N803
    ...
    def add_config(label, path=None, func=None):
        ...
        if root.parse_known_args()[0].ignoreconfig:
            ...
            current_path = os.path.join(path, 'yt-dude.conf')
...
class _YoutubeDLOptionParser(optparse.OptionParser):
    ...
    def __init__(self):
        super().__init__(
            prog='yt-dude' if detect_variant() == 'source' else None,
            version=__version__,
            usage='%prog [OPTIONS] URL [URL...]',
            epilog='See full documentation at  https://github.com/yt-dude/yt-dude#readme',
    ...
    def format_option_help(self, formatter=None):
        ...
        description = formatter.format_description(
            'Predefined aliases for convenience and ease of use. Note that future versions of yt-dude '
...
def create_parser():
    ...
    general.add_option(
        ...
        help=(
            ...
            'Use the value "auto" to let yt-dude guess ("auto_warning" to emit a warning when guessing). '
    ...
    general.add_option(
        ...
        default=[],
        help=(
            'Remote components to allow yt-dude to fetch when required. '
            'This option is currently not needed if you are using an official executable '
            'or have the requisite version of the yt-dude-ejs package installed. '
    ...
    general.add_option(
        ...
        callback_kwargs={
            ...
            'configurations by reverting some of the changes made in yt-dude. '
    ...
    authentication.add_option(
        ...
        help='Account password. If this option is left out, yt-dude will ask interactively')
    authentication.add_option(
        '-2', '--twofactor',
    ...
    authentication.add_option(
        ...
        help='Multiple-system operator account password. If this option is left out, yt-dude will ask interactively')
    authentication.add_option(
        '--ap-list-mso',
    ...
    filesystem.add_option(
        ...
        help=(
            'Location in the filesystem where yt-dude can store some downloaded information '
            '(such as client ids and signatures) permanently. By default ${XDG_CACHE_HOME}/yt-dude'))
    filesystem.add_option(
...
def _hide_login_info(opts):
    deprecation_warning(f'"{__name__}._hide_login_info" is deprecated and may be removed '
                        'in a future version. Use "yt_dude.utils.Config.hide_login_info" instead')
