...
def default_plugin_paths():
    ...
    # Load from yt-dude config folders
    yield from _get_package_paths(
        *get_user_config_dirs('yt-dude'),
        *get_system_config_dirs('yt-dude'),
        containing_folder='plugins',
    )

    # Load from yt-dude-plugins folders
    yield from _get_package_paths(
        get_executable_path(),
        *get_user_config_dirs(''),
        *get_system_config_dirs(''),
        containing_folder='yt-dude-plugins',
    )
...
class PluginFinder(importlib.abc.MetaPathFinder):
    ...
    It searches in sys.path and yt-dude config folders for
...
def load_plugins(plugin_spec: PluginSpec):
    ...
    # nor are considered part of the yt_dude_plugins namespace package
