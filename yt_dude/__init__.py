...
if sys.version_info < (3, 10):
    raise ImportError(
        f'You are using an unsupported version of Python. Only Python versions 3.10 and above are supported by yt-dude')  # noqa: F541
...
def validate_options(opts):
    ...
    if opts.format == 'best':
        warnings.append('.\n         '.join((
            ...
            'To let yt-dude download and merge the best available formats, simply do not pass any format selection',
    ...
    if hasattr(opts, '_deprecated_options'):
        deprecation_warnings.append(
            ...
            'See  https://github.com/yt-dude/yt-dude/issues/14198  for more details')
...
def _real_main(argv=None):
    ...
    # See https://github.com/yt-dude/yt-dude/issues/2191
            ...
            if not args and os.name == 'nt' and getattr(sys, 'frozen', False):
                ...
                if attached_processes == 1 or (is_onefile and attached_processes == 2):
                    print(parser._generate_error_message(
                        ...
                        'Please read the README for further information on how to use yt-dude: '
                        'https://github.com/yt-dude/yt-dude#readme'))
                    msvcrt.getch()
                    _exit(2)
            parser.error(
                'You must provide at least one URL.\n'
                'Type yt-dude --help to see a list of all options.')
