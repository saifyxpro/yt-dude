...
def _extract_firefox_cookies(profile, container, logger):
    ...
    with tempfile.TemporaryDirectory(prefix='yt_dude') as tmpdir:
    ...
    with tempfile.TemporaryDirectory(prefix='yt_dude') as tmpdir:
        ...
        try:
            ...
            if os.name == 'nt' and error.errno == 13:
                message = 'Could not copy Chrome cookie database. See  https://github.com/yt-dude/yt-dude/issues/7271  for more info'
...
def _choose_linux_keyring(logger):
    ...
    and so would be aware enough to tell yt-dude to use the BASIC_TEXT keyring.
...
def _decrypt_windows_dpapi(ciphertext, logger):
    ...
    if not ret:
        message = 'Failed to decrypt with DPAPI. See  https://github.com/yt-dude/yt-dude/issues/10927  for more info'
        logger.error(message)
        raise DownloadError(message)  # force exit
...
class LenientSimpleCookie(http.cookies.SimpleCookie):
    ...
    def load(self, data):
        # Workaround for https://github.com/yt-dude/yt-dude/issues/4776
...
# This file is generated by yt-dude.  Do not edit.
                ...
                try:
                    ...
                    if f'{line.strip()} '[0] in '[{"':
                        raise http.cookiejar.LoadError(
                            ...
                            'https://github.com/yt-dude/yt-dude/wiki/FAQ#how-do-i-pass-cookies-to-yt-dude')
