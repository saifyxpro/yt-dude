...
def get_hidden_imports():
    yield from ('yt_dude.compat._legacy', 'yt_dude.compat._deprecated')
    yield from ('yt_dude.utils._legacy', 'yt_dude.utils._deprecated')
...
datas += collect_data_files('yt_dude_ejs', includes=['**/*.js'])
